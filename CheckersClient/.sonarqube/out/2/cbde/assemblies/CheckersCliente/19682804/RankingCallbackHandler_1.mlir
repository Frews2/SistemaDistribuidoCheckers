...
%5 = cbde.unknown : none loc("D:\\ProyectosVisualStudio\\SistemaDistribuidoCheckers\\CheckersClient\\CheckersCliente\\CallbackHandlers\\RankingCallbackHandler.cs" :19 :32) // "Espere mientras se consulta" (StringLiteralExpression)
%6 = cbde.unknown : none loc("D:\\ProyectosVisualStudio\\SistemaDistribuidoCheckers\\CheckersClient\\CheckersCliente\\CallbackHandlers\\RankingCallbackHandler.cs" :19 :16) // MessageBox.Show("Espere mientras se consulta") (InvocationExpression)
br ^3
...
^4: // SimpleBlock
// Entity from another assembly: MessageBox
%11 = cbde.unknown : none loc("D:\\ProyectosVisualStudio\\SistemaDistribuidoCheckers\\CheckersClient\\CheckersCliente\\CallbackHandlers\\RankingCallbackHandler.cs" :23 :32) // "No se encuentra informacion " (StringLiteralExpression)
%12 = cbde.unknown : none loc("D:\\ProyectosVisualStudio\\SistemaDistribuidoCheckers\\CheckersClient\\CheckersCliente\\CallbackHandlers\\RankingCallbackHandler.cs" :23 :16) // MessageBox.Show("No se encuentra informacion ") (InvocationExpression)
br ^3

^5: // SimpleBlock
// Entity from another assembly: MessageBox
%13 = cbde.unknown : none loc("D:\\ProyectosVisualStudio\\SistemaDistribuidoCheckers\\CheckersClient\\CheckersCliente\\CallbackHandlers\\RankingCallbackHandler.cs" :27 :32) // "No se pudo conectarse a la base de datos" (StringLiteralExpression)
%14 = cbde.unknown : none loc("D:\\ProyectosVisualStudio\\SistemaDistribuidoCheckers\\CheckersClient\\CheckersCliente\\CallbackHandlers\\RankingCallbackHandler.cs" :27 :16) // MessageBox.Show("No se pudo conectarse a la base de datos") (InvocationExpression)
br ^3
